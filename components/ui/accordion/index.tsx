...
>(function AccordionIcon({ size, className, ...props }, ref) {
  ...
  // If consumer passes a numeric size, let the underlying Icon handle it directly.
  ...
  // Narrow to the allowed variant union to satisfy tva typing.
  const iconVariantSize = (typeof size === "string" ? size : undefined) as
    | "2xs"
    | "xs"
    | "sm"
    | "md"
